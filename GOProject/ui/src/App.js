        ...
        {!!notes && notes.map((note, index) => (
          <div className="note_full" id={"note_" + note.id} key={'note_' + index}>
            ...
            <div className="buttons">
              <img className="del_img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Flat_cross_icon.svg/1200px-Flat_cross_icon.svg.png" alt="" onClick={() => deleteNote(note.id)}></img>
              <img className="edit_img" src="https://cdn-icons-png.flaticon.com/512/1170/1170177.png" alt="" onClick={() => editNote(note.id)}></img>
            </div>
          </div>
        ))}
      </div>
